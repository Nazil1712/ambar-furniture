...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <motion.div
      ...
      className="group bg-card-bg dark:bg-neutral-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl border border-white/10 transition-all text-white p-6"
    >
      <Link
