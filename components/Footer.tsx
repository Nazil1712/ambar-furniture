  ...
  return (
    <footer className="bg-surface dark:bg-[#1A1210] border-t border-muted/20 pt-16 pb-8 mt-auto">
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div className="md:col-span-1">
          ...
          <p className="text-muted text-sm leading-relaxed mb-6 max-w-xs">
            Crafting comfort and style for modern homes. Premium quality furniture built to last generations.
          </p>
          <div className="flex gap-4">
            <a href="#" className="p-2 bg-background rounded-full text-foreground hover:text-primary transition-colors hover:bg-secondary/20">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-3 text-sm text-foreground/80">
            <li><Link href="/products?category=Sofas" className="hover:text-primary transition-colors">Sofas & Beds</Link></li>
            <li><Link href="/products?category=Storage" className="hover:text-primary transition-colors">Kitchen Cupboards</Link></li>
            <li><Link href="/products?category=Decor" className="hover:text-primary transition-colors">Wall Framing</Link></li>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-4 text-sm text-foreground/80">
            <li className="flex items-start gap-3">
              ...
              <span>123 Furniture Street, Craftsmanship District, City, Country</span>
            </li>
            ...
            <li className="flex items-center gap-3">
              ...
              <span>hello@ambarfurniture.com</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 md:px-12 text-center text-sm border-t border-muted/20 pt-8 text-muted">
        <p>&copy; {new Date().getFullYear()} Ambar Furniture. All rights reserved.</p>
      </div>
    </footer>
  );
}
