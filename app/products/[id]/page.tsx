    ...
    <div className="min-h-screen bg-background pt-24 pb-16">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          {/* Product Image */}
          <div className="relative aspect-square lg:aspect-[4/5] rounded-3xl overflow-hidden bg-surface shadow-lg">
            <Image
              src={product.image}
              alt={product.name}
              fill
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-12">
              <h3 className="font-serif text-xl font-bold mb-6">Key Features</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
              ...
              <Link 
                href="/contact"
                className="flex-1 inline-flex items-center justify-center gap-3 bg-surface border border-muted/20 hover:border-primary/50 text-foreground px-8 py-4 rounded-full font-semibold transition-all"
              >
                Contact via Form
              </Link>
            </div>
